    ...
    <div class="register-wrapper">
      ...
      <div class="register-box left">
        ...
        <form>
          ...
          <input type="password" id="confirm" placeholder="Xác nhận mật khẩu" required>

          <button class="buttonsign"><a href="sau-khi-dang-nhap.php">Đăng Ký</a></button>
      ...
      <div class="register-box right">
        <a href="sau-khi-dang-nhap.php" class="google" target="_blank">
          <img src="picture/google.png"> Đăng ký bằng Google
        </a>
        <a href="sau-khi-dang-nhap.php" class="facebook" target="_blank">
          <img src="picture/facebook.png"> Đăng ký bằng Facebook
        </a>
        <a href="sau-khi-dang-nhap.php" class="apple" target="_blank">

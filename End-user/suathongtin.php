...
<body>
  ...
  <div class="edit-container">
    ...
    <div class="avatar-section">
      <img src="picture/avatar-con-gian-cute.jpg" alt="Ảnh đại diện" class="avatar">
    ...
    <form>
      ...
      <div class="button-group">
        <button type="submit" class="btn btn-save"><a href="sau-khi-dang-nhap.php">Lưu thay đổi</a></button>
        <button type="reset" class="btn btn-cancel"><a href="sau-khi-dang-nhap.php">Hủy</a></button>
      </div>
    </form>
  </div>
